...
_convert_coords = [
    ...
    ('NR_002717.2', ('chr13', 70713886), CDNACoord(1, 0, CDNA_STOP_CODON)),  # downstream
    ('NR_002717.2', ('chr13', 70714013), CDNACoord(128, 0, CDNA_STOP_CODON)),  # downstream
    ...
    ('NR_026759.1', ('chr9', 43027589), CDNACoord(74, 0, CDNA_STOP_CODON)),  # downstream
]
